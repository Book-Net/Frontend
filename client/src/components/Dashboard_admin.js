...
function Dashboard_admin() {
  return (
    <div className='p-0 h-[auto] '>
      ...
      <div className='border-2 border-[#F1E6D9] bg-[#F2CB9E] w-1/4 h-[auto] p-4 justify-center font-roboto'>
      ...
      <div className='flex'>
         <div className='border-2 my-8 mr-5 border-[#F1E6D9] bg-[#F2CB9E] h-[auto] p-4 justify-center font-roboto'>
