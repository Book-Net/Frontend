...
// Format the date and time as a string (you can customize the format)
    ...
    return (
        <div className="bg-[#f5f5f5] py-2 mt-8  shadow-md hover:shadow-lg transition mx-auto rounded-md">
            ...
            <div className="mt-2">
            <p className="topics text-[#4F6D7A] text-[16px] text-left font-semibold ml-8 ">"Name of Author"</p>
            <p className="topics text-[#4F6D7A] text-[16px] text-left font-semibold ml-8 ">{title}</p>
            <p className="topics text-[#4F6D7A] text-[11px] text-left font-normal ml-8 ">{formattedDateTime}</p>
            </div>
            </div>
            <div className="bg-[#F2CB9E] bg-opacity-60 py-10 mt-5 mb-5   mx-auto">
              <p className= "topics text-[#BF5A36] text-[40px] text-center font-semibold ml-8 ">{desc}</p>
            </div>
           <PostActions />
        </div>
    );
