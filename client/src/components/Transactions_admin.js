...
function Transactions_admin() {
    ...
    <>
    <div className="flex">
      <div className="md:flex justify-left md:justify-between items-center space-x-2 mx-auto w-4/5 max-w-[1400px]">
        {/* Search Bar */}
...
<div className="relative overflow-x-auto float-left">
