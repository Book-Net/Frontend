        ...
        <form id='editmodal' className="w-full max-w-sm">
          <div className="mb-6 md:flex md:items-center">
            ...
            <div className="md:w-2/3">
              <input className="w-full px-4 py-2 leading-tight text-gray-700 bg-gray-200 border-2 border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-purple-500" id="about_author" type="text" defaultValue="Jane Doe"/>
            </div>
          </div>
        </form>
        </Modal.Body>
