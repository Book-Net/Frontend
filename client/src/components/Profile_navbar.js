  ...
  return (
    <div>
      <div class="font-roboto text-xl text-[#BF5A36] mx-auto font-semibold block md:w-[1400px] md:flex">
        <button onClick={(evt) => openCity(evt, 'dashboard')} id="defaultOpen"  className=" tablinks my-1 min-w-[300px] hover:border-r-2 hover:border-b-0 hover:border-l-2 hover:border-t-2 hover:transition hover:duration-200 rounded-tr-lg px-4 py-2 border-b-2 border-[#BF5A36]">
            Dashboard
        </button>
        <button
        ...
        <button
          ...
          className="tablinks my-1 min-w-[300px] hover:border-r-2 hover:border-b-0 hover:border-l-2 hover:border-t-2 hover:transition hover:duration-200 rounded-t-lg px-4 py-2 border-b-2 border-[#BF5A36]"
        >
          Favorites
        </button>
