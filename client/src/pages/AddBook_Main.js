    ...
    <div>
      <section className="bg-white  py-4 w-[850px] m-auto rounded-lg shadow-inherit mt-4">
        <div className="py-4 px-4 mx-auto max-w-2xl">
          <p className="topics text-[#4F6D7A] text-3xl text-center font-semibold mb-4 ">
            Add Book
          </p>
          ...
          <form onSubmit={(e) => handleSubmit(e)} encType="multipart/form-data">
            <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
              ...
              <div className="w-full">
                ...
                <select
                  className="bg-gray-50 border border-[#BF5A36] border-opacity-30 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5"
