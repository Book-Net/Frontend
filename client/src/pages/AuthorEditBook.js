        ...
        <div className="h-screen">
            ...
            <section class="bg-white  py-4 w-[850px] m-auto rounded-lg shadow-inherit mt-6">
                <div class="py-4 px-4 mx-auto max-w-2xl">
                    <p className="topics text-[#4F6D7A] text-3xl text-center font-semibold mb-8 mt-5">Edit Book</p>
                    ...
                    <form action="#">
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div class="w-full">
                                ...
                                <input className="bg-gray-50 border border-[#BF5A36] border-opacity-30 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Price (Rs.)" required="" />
                            </div>
